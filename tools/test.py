...
def parse_args():
    ...
    parser.add_argument('--data_path', default='/home/robin/datatsets/xray', help='the dataset dir')
    parser.add_argument('--output_path', default='./work_dir', help='the dir to save models')
    parser.add_argument('--visualPath', default='./work_dir', help='visual tensorboard path')
